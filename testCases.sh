...
#curl -i -X POST --data '{"location":{"description": "Ochard 2","address1": "4 Real Rd","address2": "","city": "Guelph","postal": "N1G O0O","country": "Canada","latitude": "43.530766","longitude":"-80.229016"}}' 127.0.0.1:3000/user/1/locations ;echo -e "\n"
...
curl -i -X POST --data '{"event":{"owner":{"id":1},"description":"Come pick my 4 apple trees!","location":{"id":4},"datetime":"2014-11-18T16:20:27.174Z","endtime":"2014-11-21T16:20:27.174Z","trees":[{"type":"Apple","quantity":2}],"attendees":[{"id":1},{"id":2}],"staffNotes":""}}' 127.0.0.1:3000/events
